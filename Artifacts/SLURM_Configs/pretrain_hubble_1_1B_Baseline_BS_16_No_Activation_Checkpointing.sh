#!/bin/bash
#SBATCH --job-name="hubble_1_1B_Baseline_BS_16_No_Activation_Checkpointing"
#SBATCH --partition=a100
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=8
#SBATCH --gres=gpu:8
#SBATCH -o /NS/llm-pretraining/work/afkhan/USC_Colab/gpt-neox/Artifacts/SLURM_Logs/hubble_1_1B_Baseline_BS_16_No_Activation_Checkpointing_%x_%j_%A-%T.out
#SBATCH -e /NS/llm-pretraining/work/afkhan/USC_Colab/gpt-neox/Artifacts/SLURM_Logs/hubble_1_1B_Baseline_BS_16_No_Activation_Checkpointing_%x_%j_%A-%T.err
...
cd /NS/llm-pretraining/work/afkhan/USC_Colab/gpt-neox && python ./deepy.py train.py ./configs/hubble/Speed_Exps/1_1B_Baseline_BS_16_No_Activation_Checkpointing.yml