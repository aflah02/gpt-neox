#!/bin/bash
#SBATCH --job-name="hubble_2_8B_Baseline_BS_4_GAS_16_GQA_KV_Heads_4_Fusions_3_No_Act_Ckpt_FA_Swiglu_"
#SBATCH --partition=a100
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=8
#SBATCH --gres=gpu:8
#SBATCH -o /NS/llm-pretraining/work/afkhan/USC_Colab/gpt-neox/Artifacts/SLURM_Logs/hubble_2_8B_Baseline_BS_4_GAS_16_GQA_KV_Heads_4_Fusions_3_No_Act_Ckpt_FA_Swiglu_%x_%j_%A-%T.out
#SBATCH -e /NS/llm-pretraining/work/afkhan/USC_Colab/gpt-neox/Artifacts/SLURM_Logs/hubble_2_8B_Baseline_BS_4_GAS_16_GQA_KV_Heads_4_Fusions_3_No_Act_Ckpt_FA_Swiglu_%x_%j_%A-%T.err
#SBATCH --time=1:00:00
#SBATCH --exclusive
#SBATCH --mem=0
...
cd /NS/llm-pretraining/work/afkhan/USC_Colab/gpt-neox && python ./deepy.py train.py ./configs/hubble/Speed_Exps/2_8B_Baseline_BS_4_GAS_16_GQA_KV_Heads_4_Fusions_3_No_Act_Ckpt_FA_Swiglu.yml